...
module ecs{
    ...
    export class Node{
        ...
        addChild(child:Node){
            ...
            //可视化
            if(MODE === MODE_PREVIEW || child.visualable){
    ...
    export function assembleSingleComponent(component:Component,currentNode:Node,references:any){
    ...
    function injectPropertiesByOrder(propsWrapper:any,target:Node|Component,orderList:[string]){
        orderList.forEach(props=>{
